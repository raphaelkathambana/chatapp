...
<!-- <span class="material-symbols-outlined">
            ...
            <div class="avatar_container">
                ...
                <div class="avatars">
                    <img onclick="handleClickAvatar('avatar1')" class="avatar" src="{{asset('avatars/avatar1.png')}}" alt="avatar1">
                    <img onclick="handleClickAvatar('avatar2')"  class="avatar" src="{{asset('avatars/avatar2.png')}}" alt="avatar2">
                    <img onclick="handleClickAvatar('avatar3')"  class="avatar" src="{{asset('avatars/avatar3.png')}}" alt="avatar3">
                    <img onclick="handleClickAvatar('avatar4')"  class="avatar" src="{{asset('avatars/avatar4.png')}}" alt="avatar4">
                    <img onclick="handleClickAvatar('avatar5')"  class="avatar" src="{{asset('avatars/avatar5.png')}}" alt="avatar5">
                    <img onclick="handleClickAvatar('avatar6')"  class="avatar" src="{{asset('avatars/avatar6.png')}}" alt="avatar6">
